...
export default function ResultsScreen() {
  ...
  const { shape, runCoords, duration } = useLocalSearchParams();

  const selectedShape = JSON.parse(shape);
  const userPath = JSON.parse(runCoords);
  const durationSeconds = JSON.parse(duration);
  const AnimatedSvg = Animated.createAnimatedComponent(Svg);

  console.log(selectedShape, userPath, durationSeconds);
  // const userPath = [
  // 	{ latitude: -32.2515089, longitude: 148.6301891 }, // Bottom Tip (Starting Point)
  // 	{ latitude: -32.2428263, longitude: 148.62253 },
  // 	{ latitude: -32.2339923, longitude: 148.6161408 },
  // 	{ latitude: -32.2254463, longitude: 148.612641 },
  ...
  // 	{ latitude: -32.2064211, longitude: 148.632446 },
  ...
  const handleSave = () => {
    try {
      axios.post("https://tracr-c546.onrender.com/api/expeditions", {
